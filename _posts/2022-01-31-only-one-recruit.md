...
<div class="table-mobile">
    <table>
        ...
        <tr>
            ...
            <th style="text-align:right; border: 0px !important"><small class="btn btn-col status-button">Programming</small><small class="btn btn-col status-button">Level Design</small></th>
        </tr>
    </table>
</div>
...
<!--- ---------------------------- -->
<div class = "card">
    <h2 style="text-align: center;">About Only One Recruit</h2>
    <p style="text-align: center;">Only One Recruit is a puzzle game designed around the theme 'Only One'  made for <a href="https://itch.io/jam/gmtk-2019" target="_blank" style="padding: 2px">GMTK Game Jam</a> <br /> The game was made with a team of 2, including me! <br /> A dungeon crawler game where each character has only one ability. They are able to use their ability only once per level. Each character and enemy has only one health. You can build up a party but can control only one character at time. </p>
</div>

<!--- ------------------------------------ -->
<!--- Embed or Youtube Footage of the game -->
<!--- ------------------------------------ -->
<div style="text-align: center;"><iframe frameborder="0" src="https://itch.io/embed-upload/1578595?color=333333" allowfullscreen="" width="1000" height="700"><a href="https://horsehead.itch.io/gmtk-gamejam-2019">Play Only One Recruit on itch.io</a></iframe></div>
<hr>
<!--- ------------------------------------ -->
...
<div id="collapseGall" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
    <div class="panel-body">
        <div class = "widcard" style="background-color: #1c1c1e; margin-bottom: 0px !important">
            <img src="/assets/img/posts/OnlyOneRecruit/1.png" style="max-width: -webkit-fill-available; box-shadow: 0px 0px 20px #202022;">
        </div>
        <div class = "widcard" style="background-color: #1c1c1e; margin-bottom: 0px !important">
            <img src="/assets/img/posts/OnlyOneRecruit/2.png" style="max-width: -webkit-fill-available; box-shadow: 0px 0px 20px #202022;">
        </div>
    </div>
</div>
